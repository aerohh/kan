    ...
    <Menu as="div" className="relative inline-block w-full text-left">
      <div>
        {isLoading ? (
          ...
          <div className={twMerge("flex w-full items-center", isCollapsed && "flex-col items-center gap-3")}>
            {isCollapsed && <ThemeSwitcher isCollapsed />}
            <Menu.Button
              className="flex flex-1 items-center rounded-md p-1.5 text-neutral-900 hover:bg-light-200 dark:text-dark-900 dark:hover:bg-dark-200 dark:hover:text-dark-1000"
