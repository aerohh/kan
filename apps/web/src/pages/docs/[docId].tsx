    ...
    <div className="flex h-full flex-col">
      <div className="flex items-center bg-light-50 px-4 py-1.5 dark:bg-dark-50">
        <button
          ...
          className="flex h-7 items-center gap-1.5 rounded-md px-2 text-[13px] text-light-800 transition-colors hover:bg-light-200 hover:text-light-900 dark:text-dark-800 dark:hover:bg-dark-200 dark:text-dark-900"
        >
